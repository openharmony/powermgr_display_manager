...
namespace {
    ...
    const uint32_t INIT_WAITING = 50 * 1000; // 50ms
}
...
namespace {
HWTEST_F(BrightnessManagerExtTest, NoInit001, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.NoInit001 function start!");
    g_BrightnessManagerExt.CloseBrightnessExtLibrary();
    EXPECT_EQ(g_BrightnessManagerExt.GetState(), DisplayState::DISPLAY_UNKNOWN);
    ...
    EXPECT_FALSE(retBool);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.NoInit001 function end!");
}

HWTEST_F(BrightnessManagerExtTest, MockInit001, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit001 function start!");
    ...
    MockClearValues();
    EXPECT_TRUE(retBool);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit001 function end!");
}

HWTEST_F(BrightnessManagerExtTest, MockInit002, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit002 function start!");
    MockInitBrightnessManagerExt(g_BrightnessManagerExt);
    MockClearValues();
    ...
    MockClearValues();
    EXPECT_TRUE(retBool);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit002 function end!");
}

HWTEST_F(BrightnessManagerExtTest, MockInit003, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit003 function start!");
    MockInitBrightnessManagerExt(g_BrightnessManagerExt);
    MockClearValues();
    ...
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.MockInit003 function end!");
}

HWTEST_F(BrightnessManagerExtTest, NoInit002, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.NoInit002 function start!");
    g_BrightnessManagerExt.CloseBrightnessExtLibrary();
    EXPECT_EQ(g_BrightnessManagerExt.GetState(), DisplayState::DISPLAY_UNKNOWN);
    ...
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.NoInit002 function end!");
}

HWTEST_F(BrightnessManagerExtTest, InitWithDlopen001, TestSize.Level1)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.InitWithDlopen001 function start!");
    g_BrightnessManagerExt.CloseBrightnessExtLibrary();
    EXPECT_EQ(g_BrightnessManagerExt.GetState(), DisplayState::DISPLAY_UNKNOWN);
    ...
    EXPECT_NE(g_BrightnessManagerExt.UnregisterDataChangeListener(ChangeType::STABLE_LUX, ""), 0);
    auto callerId = "1645_";
    EXPECT_EQ(g_BrightnessManagerExt.RegisterDataChangeListener(listener, ChangeType::STABLE_LUX, callerId, ""), 0);
    EXPECT_EQ(g_BrightnessManagerExt.UnregisterDataChangeListener(ChangeType::STABLE_LUX, callerId), 0);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerExtTest.InitWithDlopen001 function end!");
}
