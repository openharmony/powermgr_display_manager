...
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerNoInit001 function start!");
    ...
    EXPECT_FALSE(retBool);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerNoInit001 function end!");
}

HWTEST_F(BrightnessManagerExtTest, MockInit001, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerMockInit001 function start!");
    // 打桩
    ...
    MockClearValues();
    EXPECT_TRUE(retBool);
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerMockInit001 function end!");
}

HWTEST_F(BrightnessManagerExtTest, MockInit002, TestSize.Level0)
{
    DISPLAY_HILOGI(LABEL_TEST, "BrightnessManagerMockInit002 function start!");
    MockSetValue(8.0);
    usleep(DEFAULT_WAITING_TIME);
