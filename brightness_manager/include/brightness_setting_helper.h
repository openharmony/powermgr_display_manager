...
#ifndef BRIGHTNESS_SETTING_HELPER_H
#define BRIGHTNESS_SETTING_HELPER_H
...
private:
    ...
    static sptr<SettingObserver> mAutoBrightnessObserver;
    static sptr<SettingObserver> mBrightnessObserver;
};
} // namespace PowerMgr
} // namespace OHOS

#endif // BRIGHTNESS_SETTING_HELPER_H