...
#ifndef DISPLAYMGR_MULTI_SCREEN_DISPLAY_STATE_CALLBACK_STUB_H
#define DISPLAYMGR_MULTI_SCREEN_DISPLAY_STATE_CALLBACK_STUB_H
...
private:
    int32_t OnMultiScreenDisplayStateChangedStub(MessageParcel& data, MessageParcel& reply);
};
} // namespace DisplayPowerMgr
} // namespace OHOS
#endif // DISPLAYMGR_MULTI_SCREEN_DISPLAY_STATE_CALLBACK_STUB_H
