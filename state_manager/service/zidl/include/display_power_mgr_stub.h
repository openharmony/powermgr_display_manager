...
private:
    int32_t RemoteRequest(uint32_t code, MessageParcel &data, MessageParcel &reply, MessageOption &option);
    ...
    int32_t SetScreenOnBrightnessStub(MessageParcel& data, MessageParcel& reply);
