...
{
    DISPLAY_HILOGI(MODULE_SERVICE, "GetPowerState of displayId=%{public}u", displayId);
...
{
    DISPLAY_HILOGI(MODULE_SERVICE, "SetDisplayState: displayId=%{public}u, state=%{public}u",
...
{
    DISPLAY_HILOGI(MODULE_SERVICE, "SetDisplayPower: displayId=%{public}u, state=%{public}u, state=%{public}u",
...
uint32_t ScreenAction::GetBrightness(uint32_t displayId)
{
    ...
    DISPLAY_HILOGD(MODULE_SERVICE, "displayId=%{public}u, brightness=%{public}u", displayId, brightness);
    return brightness;
}

bool ScreenAction::SetBrightness(uint32_t displayId, uint32_t value)
{
    DISPLAY_HILOGI(MODULE_SERVICE, "displayId=%{public}u, brightness=%{public}u", displayId, value);
