...
#define RETURN_IF_WITH_LOG(cond, loginfo)                                                   \
    do {                                                                                \
        if (cond) {                                                                     \
            DISPLAY_HILOGE(MODULE_COMMON, "%{public}s "#loginfo" ", __func__);                                     \
            return;                                                                     \
        }                                                                               \
    } while (0)                                                                         \
...
#define READ_PARCEL_NO_RET(parcel, type, out)                                           \
    do {                                                                                \
        if (!(parcel).Read##type(out)) {                                                \
            DISPLAY_HILOGE(MODULE_COMMON, "%{public}s read "#out" failed", __func__);                          \
            return;                                                                     \
        }                                                                               \
    } while (0)                                                                         \
...
#define WRITE_PARCEL_NO_RET(parcel, type, data)                                         \
    do {                                                                                \
        if (!(parcel).Write##type(data)) {                                              \
            DISPLAY_HILOGE(MODULE_COMMON, "%{public}s write "#data" failed", __func__);                        \
            return;                                                                     \
        }                                                                               \
    } while (0)                                                                         \
